        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-12 row">
              ...
              <div class="col-9">
                <input type="text" class="form-control col-7 float-left" v-model="mark">
                <button type="button" class="btn btn-primary btn-sm btn-round btn-fill px-4 col-4 float-right" @click="fakeVote()" :disabled="saving">
                  {{saving ? 'Voting...' : 'Vote'}}
                </button>
              </div>
            </div>
